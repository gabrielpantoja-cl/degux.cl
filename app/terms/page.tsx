...
export default function TermsPage() {
  ...
  <p className="mb-4 text-gray-700">
    Referenciales.cl se compromete a cumplir con la Ley N° 19.628 sobre Protección de Datos Personales, 
    asegurando que todos los datos personales recolectados y procesados en la plataforma sean tratados 
    de manera segura y conforme a la ley. Esto incluye, pero no se limita a, los siguientes aspectos:
  </p>
  <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
    <li>
      <span className="font-medium">Derecho de Acceso:</span> Los usuarios tienen el derecho a acceder 
      a sus datos personales almacenados en la plataforma.
    </li>
    <li>
      <span className="font-medium">Derecho de Rectificación:</span> Los usuarios pueden solicitar la 
      corrección de sus datos personales si estos son inexactos o están desactualizados.
    </li>
    <li>
      <span className="font-medium">Derecho de Cancelación:</span> Los usuarios tienen el derecho a 
      solicitar la eliminación de sus datos personales cuando estos ya no sean necesarios para los 
      fines para los que fueron recolectados, o cuando el usuario retire su consentimiento.
    </li>
    <li>
      <span className="font-medium">Derecho de Oposición:</span> En casos específicos, los usuarios 
  ...
  Para ejercer cualquiera de estos derechos o realizar consultas, los usuarios pueden unirse a 
  nuestro canal oficial de soporte en:{' '}
  <a 
  ...
  <div className="bg-gray-50 p-4 rounded-lg">
    ...
    <p className="text-gray-700">
      Referenciales.cl implementa medidas técnicas y organizativas adecuadas para proteger los datos 
